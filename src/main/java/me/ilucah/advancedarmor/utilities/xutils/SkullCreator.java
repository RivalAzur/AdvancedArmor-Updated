package me.ilucah.advancedarmor.utilities.xutils;
...
public class SkullCreator {
    ...
    public static ItemStack createSkullFromString(String string) {
        if (string.length() < 24)
            return itemFromName(string);
        else if (string.contains("minecraft"))
            return itemFromBase64(urlToBase64(string));
        else
            return itemFromBase64(string);
    }
