...
public class EDPrisonPumpkinsProvider extends BoostProvider<EdPrisonAddMultiplierCurrency> {

public EDPrisonPumpkinsProvider(AdvancedArmor instance) {
        super(instance, BoostType.PUMPKINS);
...
public void onBoost(EdPrisonAddMultiplierCurrency event) {
        ...
        if (event.getCurrency().equalsIgnoreCase("pumpkins")) {
